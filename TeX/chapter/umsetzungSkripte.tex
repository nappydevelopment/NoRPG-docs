  ...
  IEnumerator RegisterUser(string user, string email, string password, string firstname, 
    ...
    if (hs_post.error != null) {
      ...
      status.text = hs_post.text;
			...
			Für den Login innerhalb der App wird identisch vorgegangen. Dabei wird jedoch ein Datensatz in die Datenbank geschrieben, sondern nur gelesen. Des weiteren wird der Hash aus nicht so vielen Werten gebildet, da nur der Username und das verschlüsselte Passwort übermittelt werden.
