      ...
      status.text = hs_post.text;
		...
		\subsection{Datenhaltung auf dem Handy}
			...
			\subsubsection{Standards \ac{JSON}}
				...
				Für das Laden und verarbeiten sind fünf Klassen verantwortlich. Im Folgenden wird nur detailliert auf die Klasse „WebJSONConfigReader” eingegangen. Die anderen Klassen sind im Anhang (s. Anhang \ref{anhang4}) abgebildet und werden nur erwähnt.
