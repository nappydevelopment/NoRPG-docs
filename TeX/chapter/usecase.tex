...
\section{Spezifische Anforderungen}
	...
	\subsection{Externe Schnittstellen}
		...
		\subsubsection{Systemschnittstellen}
			...
			Das Datenformat von Android ist das \ac{APK} und wird für die Distribution und Installation von mobilen Apps auf Android Smartphones verwendet. Eine \ac{APK}-Datei enthält den gesamten Programmcode, Ressourcen, Assets, Zertifikate und Metadaten. Verglichen kann das Datenformat von Google mit einem ZIP-Archiv\footnote{vgl. Morrill \cite{google1} (2008)}. Dieses Format muss NoRPG erfüllen, um unabhängig von den zu implementierenden Produktfunktionen auf einem Android Smartphone laufen zu können.
	...
	\subsection{Funktionale Anforderungen}
		...
		\subsubsection{View progress}
			...
			Dieser Use Case hat die gleichen Vorbedingungen wie der vorherige Use Case. Der Spieler muss sich im Spiel befinden, darf in keiner aktiven \ac{NPC} InteraktionDie  sein.
		...
		\subsubsection{Control character}
			...
			Das Activity Diagramm dieses Use Cases in Abbildung \ref{umlControl} ist im Vergleich zu den bisherigen Diagrammen besonders, denn es existiert keinen Endpunkt. Dieser ist zugleich der Startpunkt des Diagramms.
	...
	\subsection{Benutzerfreundlichkeit}
		...
		Damit die Benutzeroberfläche freundlich für den Benutzer ist, muss sie in das Profil des Benutzers passen. Da NoRPG sich grundsätzlich an Kinder richtet muss die Bedienung und Gestaltung der App kindgerecht sein. Damit eine App als kindgerecht bezeichnet werden kann muss es nach Wendy B. von Intel vier Prinzipien erfüllen \footnote{vgl. Wendy B. \cite{intelKids} (2013)}.
