...
\section{Spezifische Anforderungen}
	...
	%	l) End messages.
		...
		\subsubsection{Benutzerschnittstellen}
			...
			Wenn der Benutzer NoRPG das erste Mal startet oder nicht angemeldet ist, wird ihm die Login-Oberfläche präsentiert. Auf dieser Oberfläche hat der Benutzer die Möglichkeit sich mit seinem Benutzernamen und  Passwort anzumelden oder sich, falls noch nicht geschehen, bei NoRPG zu registrieren. Das Smartphone muss Quer gehalten werden, da alle Elemente des Bildschirms für diese Ausrichtung angeordnet sind. Diese Eigenschaft betrifft auch alle anderen Benutzerschnittstellen.  
			...
			\begin{center}
				...
				\captionof{figure}{Mockup: Head-Up Display} 
			\end{center}
			...
			\begin{center}
				...
				\captionof{figure}{Mockups: Spieleliste, Fortschrittanzeige und Karte} 
			\end{center}
		
		\subsubsection{Hardwareschnittstellen}
			Hardwareschnittstellen spezifizieren die logischen Eigenschaften jeder Schnittstelle zwischen NoRPG und den Hardwarekomponenten des Systems. 
			
			Ein Smartphone besteht aus sehr vielen Hardwarekomponenten. Jede einzelne Komponente wird benötigt, damit das Smartphone mit seinem kompletten Funktionsumfang funktioniert. Jedoch spielen einige Hardwarekomponenten eine besondere Rolle für NoRPG. Neben unverzichtbaren und nicht extra erwähnenswerten Komponenten wie den Prozessor, Speicher oder Akku zählen zu den Kernkomponenten der Touchscreen, WLAN-Adapter und
			
			
			Zu einem der Touchscreen eines Smartphones -> Toucheingaben für die Steuerung des Charakters, Interaktion mit dem Spiel, Menü, etc --> die einzige Benutzerschnittstelle
