...
\section{Allgemeine Beschreibung}
	...
	\subsection{Produktperspektive}
		%Bei NoRPG handelt es sich nicht um ein selbstständiges abgeschlossenes Projekt. 
		...
		%Es wird zwischen verschiedenen Schnittstellentypen unterschieden. Beispielsweise gibt es System-, Benutzer-, Hardware- oder Softwareschnittstellen. 
		
		%Systemschnittstellen: each system interface and identify the functionality of the software to accomplish the system requirement and the interface description to match the system. Bei NoRPG gibt es keine Systemschnittstellen. (Oder etwa Android???)
		...
		%Hardwareschnittstellen: each interface between the software product and the hardware components of the system. This includes configuration characteristics. Bei NoRPG Smartphone und seine Komponenten (Touchscreen, Speaker, ...). Dann noch Datenbank
